...
if(BUILD_MEDIASTREAMER2)
	...
	if(ENABLE_AAUDIO)
		function(add_msaaudio)
			set(BUILD_SHARED_LIBS ${BUILD_MSAAUDIO_SHARED_LIBS})
	...
	if(ENABLE_CAMERA2)
		function(add_msandroidcamera2)
			set(BUILD_SHARED_LIBS ${BUILD_MSANDROIDCAMERA2_SHARED_LIBS})
			add_subdirectory("msandroidcamera2")
		endfunction()
		add_msandroidcamera2()
	...
	if(ENABLE_WEBRTC_AEC OR ENABLE_WEBRTC_VAD)
		function(add_mswebrtc)
			set(BUILD_SHARED_LIBS ${BUILD_MSWEBRTC_SHARED_LIBS})
...
if(BUILD_LIBLINPHONE)
	function(add_liblinphone)
		...
		if(ANDROID_BUNDLED)
			add_dependencies(liblinphone ${MEDIASTREAMER2_PLUGINS_TARGETS})
		endif()
